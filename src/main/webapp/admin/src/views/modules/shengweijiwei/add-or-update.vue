          ...
          <el-form-item class="input" label="昵称" prop="nicheng">
              <el-input v-model="ruleForm.nicheng" 
                placeholder="昵称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属省份" prop="suoshushengfen">
          <el-input v-model="ruleForm.suoshushengfen" 
              placeholder="所属省份" clearable  :readonly="ro.suoshushengfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属省份" prop="suoshushengfen">
              <el-input v-model="ruleForm.suoshushengfen" 
                placeholder="所属省份" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
            ...
            ruleForm: {
                	        shengweizhanghao: '',
	                        	        ...
	                        	        jianjie: '',
                                                                                                ...
                                                                                                rules: {
                  shengweizhanghao: [
                            { required: true, message: '省卫账号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.nicheng = true;
            continue;
	            	            ...
	            	            if(o=='suoshushengfen'){
            this.ruleForm.suoshushengfen = obj[o];
	    this.ro.suoshushengfen = true;
            continue;
          }
	            	            if(o=='lianxifangshi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shengweijiwei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shengweijiweiCrossAddOrUpdateFlag = false;
                  this.parent.search();
