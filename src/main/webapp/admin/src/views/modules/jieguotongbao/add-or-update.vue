...
export default {
  data() {
	...
	tongzhiriqi : false,
            ...
            ruleForm: {
                  ...
                  shenqingzhicheng: [
                            { required: true, message: '申请职称不能为空', trigger: 'blur' },
                                    	                                                              ],
                  gonghao: [
                                    	                                                              ],
                  zhenshixingming: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jieguotongbao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jieguotongbaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
