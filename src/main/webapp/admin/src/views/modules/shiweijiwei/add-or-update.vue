<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="市卫账号" prop="shiweizhanghao">
          <el-input v-model="ruleForm.shiweizhanghao" 
              placeholder="市卫账号" clearable  :readonly="ro.shiweizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="市卫账号" prop="shiweizhanghao">
              <el-input v-model="ruleForm.shiweizhanghao" 
                placeholder="市卫账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="昵称" prop="nicheng">
              <el-input v-model="ruleForm.nicheng" 
                placeholder="昵称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属城市" prop="suoshuchengshi">
          <el-input v-model="ruleForm.suoshuchengshi" 
              placeholder="所属城市" clearable  :readonly="ro.suoshuchengshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属城市" prop="suoshuchengshi">
              <el-input v-model="ruleForm.suoshuchengshi" 
                placeholder="所属城市" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	shiweizhanghao : false,
	mima : false,
	nicheng : false,
	suoshuchengshi : false,
	lianxifangshi : false,
	jianjie : false,
      },
            ruleForm: {
                	        shiweizhanghao: '',
	                        	        ...
	                        	        jianjie: '',
                                                                                                ...
                                                                                                rules: {
                  shiweizhanghao: [
                            { required: true, message: '市卫账号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='shiweizhanghao'){
            this.ruleForm.shiweizhanghao = obj[o];
	    this.ro.shiweizhanghao = true;
            continue;
          }
	            	            if(o=='mima'){
	    ...
	    this.ro.nicheng = true;
            continue;
	            	            ...
	            	            if(o=='suoshuchengshi'){
            this.ruleForm.suoshuchengshi = obj[o];
	    this.ro.suoshuchengshi = true;
            continue;
          }
	            	            if(o=='lianxifangshi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shiweijiwei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shiweijiweiCrossAddOrUpdateFlag = false;
                  this.parent.search();
